...
const faqs = [
  ...
  {
    q: '나이 제한이 있나요?',
    a: '성인 취미 연기부터 입시·경력 배우까지 연령 제한은 없습니다. 지망생부터 직장인, 경력 배우까지 다양한 연령대가 함께 훈련합니다.',
  },
  {
    q: '직장인도 수강 가능한가요?',
    a: '가능합니다. 평일 저녁·주말 클래스 중심으로 운영하며(월~토 10:00–22:00, 일요일 휴무), 마이즈너 정규·출연영상은 회당 4시간, 베이직은 매주 토요일 12:00–15:00 회당 3시간입니다. 기수별 정확한 요일은 상담 시 안내드립니다.',
  },
  {
    q: '레피티션이란 무엇인가요?',
    a: '마이즈너 테크닉의 핵심 훈련법입니다. 두 명이 짧은 대사를 반복하며 상대의 미세한 변화에 반응하는 훈련으로, 머리로 연기하는 습관을 벗고 본능을 회복하는 훈련입니다. 레피티션 3단계로 시작해 Activity & Door 훈련으로 확장됩니다. 감정을 혼자 만들지 않고 상대에게서 촉발된 충동에 반응하는 것이 핵심입니다.',
  },
  {
    q: '배우 DB 등록은 어떻게 하나요?',
    a: 'KD4 멤버는 프로필을 등록하면 바로 배우 DB에 공개됩니다. 사진·필모그래피·출연영상을 포함한 프로필이 kd4.club 배우 DB에 올라가며, 캐스팅 관계자가 실제로 조회합니다.',
  },
  {
    q: '촬영 경험이 없어도 되나요?',
  ...
  {
    q: '캐스팅 디렉터와 연결해주나요?',
    a: '네. 방진원·이상원 캐스팅 디렉터와 공식 협업하며 정기 오디션 및 캐스팅을 연계합니다. 최근 캐스팅 80건이 이뤄졌습니다. kd4.club 배우 DB를 통해 캐스팅팀이 직접 배우를 조회합니다.',
  },
  {
    q: '입시 준비생도 다닐 수 있나요?',
  ...
  },
  {
    ...
    a: '마이즈너 테크닉은 레피티션(반복 훈련) 3단계를 기반으로 시작합니다. KD4 클래스 구조는 STEP 1(베이직·마이즈너 정규·출연영상) → STEP 2(출연영상 심화) → STEP 3(액터스 리더·오디션 테크닉)으로 이어집니다. 레피티션 외에도 Activity & Door, Emotional Preparation 등을 단계별로 훈련합니다.',
  },
  {
    q: 'KD4에 다닌 배우들이 실제로 캐스팅된 사례가 있나요?',
    a: '네. KD4 멤버들이 Disney+ 무빙, Netflix 중증외상센터, tvN 금쪽같은 내 스타 등 드라마·영화·CF에 실제 출연했습니다. 최근 캐스팅 80건의 연계 실적이 있으며, kd4.club 배우 DB에서 필모그래피를 직접 확인할 수 있습니다.',
  },
  {
    q: '수업은 몇 명이 함께 하나요?',
