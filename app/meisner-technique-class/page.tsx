...
export const metadata: Metadata = {
  ...
  description:
    '마이즈너 Repetition 훈련으로 억지 감정 없이 살아있는 연기를 만듭니다. 권동원 대표 직강, 4개월 코스, 정원 8명 소수정예. 감정 해방·이바나 처벅 테크닉·독백. 서울 신촌 이대역 도보 3분.',
  keywords: [
    '마이즈너 테크닉',
    '마이즈너 정규반',
    '연기 입문',
        ...
        <div className="container">
          ...
          <div className="meisner-director-grid" style={{ display: 'grid', gridTemplateColumns: 'auto 1fr', gap: '32px', alignItems: 'start', maxWidth: '780px', margin: '0 auto' }}>
            <div style={{ position: 'relative', width: '200px', height: '266px', borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--border)' }}>
              <Image src={DIRECTOR.photo} alt={`${DIRECTOR.name} 대표`} fill priority fetchPriority="high" sizes="200px" style={{ objectFit: 'cover' }} />
            </div>
            <div>
