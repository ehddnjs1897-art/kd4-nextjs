...
export const metadata: Metadata = {
  ...
  description:
    'KD4 동료 배우들이 누리는 혜택과 커뮤니티 — 보강제도, 출연영상·프로필 편집 서비스, 레피티션 스터디, 굿무비 굿액팅, 크리스쳔 액터스.',
}
...
const COMMUNITIES: CommunityItem[] = [
  ...
  },
  {
    ...
    leader: '박우진 리더',
    desc: '동료 배우들과 함께 영화를 보고 토론하는 모임. 연기를 보는 눈과 영화를 보는 눈을 함께 키우며, 영화와 연기를 더 깊이 사랑하게 되는 시간.',
  },
  {
    icon: '✝️',
    title: '크리스쳔 액터스',
...
const DISCOUNTS = [
  ...
  { tag: '출연영상·심화 클래스 할인', title: '출연영상 · 심화 클래스 30% 할인', desc: '출연영상 2회 이상 수강 배우 적용' },
  { tag: '지인 동반 할인', title: '함께 등록 시 1+1 · 두 분 모두 3만원 할인', desc: '지인과 동반 등록 시 두 분 각각 3만원씩 할인' },
