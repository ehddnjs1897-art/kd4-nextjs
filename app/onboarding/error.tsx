  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0 20px' }}>
      <div style={{ textAlign: 'center', maxWidth: 400 }}>
        ...
        <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '1.3rem', color: 'var(--white)', marginBottom: 12 }}>온보딩 페이지를 불러오지 못했습니다</h2>
        ...
        <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          <Link href="/dashboard" style={{ background: 'transparent', color: 'var(--gray)', border: '1px solid var(--border)', borderRadius: 6, padding: '11px 24px', fontSize: '0.88rem', textDecoration: 'none', display: 'inline-block' }}>마이페이지로</Link>
        </div>
      </div>
    </div>
  )
