...
export const metadata: Metadata = {
  title: '커뮤니티',
  description: 'KD4 멤버들의 연기·오디션 이야기, 클래스 후기, 공지사항을 함께 공유하는 커뮤니티입니다.',
  openGraph: {
    type: 'website',
  ...
  twitter: {
    ...
    title: '커뮤니티 — KD4 액팅 스튜디오',
    description: 'KD4 멤버들의 연기·오디션 이야기, 클래스 후기, 공지사항을 함께 공유하는 커뮤니티입니다.',
    images: [{ url: `${SITE_URL}/og-image.jpg`, width: 1200, height: 630, alt: 'KD4 액팅 스튜디오 커뮤니티', type: 'image/jpeg' }],
  },
    ...
    return (
      <div style={{ minHeight: '100vh', background: 'var(--bg)', padding: '80px 0 120px' }}>
        <div className="container">
          <p role="alert" aria-atomic="true" style={{ color: 'var(--gray)', fontSize: '0.95rem', marginTop: '40px' }}>
