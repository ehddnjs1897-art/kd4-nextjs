    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)', paddingTop: 110, paddingBottom: 100 }}>
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '0 24px' }}>
        ...
        <ul style={UL}>
          ...
          <li style={LI}><strong>(선택) 오디션·캐스팅 기회, 클래스 개강 소식 안내</strong> — 소식 수신에 동의한 회원에 한해 이름·휴대폰 번호·이메일로 문자·메일을 보냅니다. 동의하지 않아도 가입과 서비스 이용에 제한이 없으며, 마이페이지의 「수신 끄기」 또는 메시지의 수신거부 안내로 언제든 철회할 수 있습니다. 철회 또는 회원 탈퇴 시까지 이용합니다.</li>
        </ul>
