...
export const metadata: Metadata = {
  title: {
    default: 'KD4 액팅 스튜디오 | 서울 신촌·이대 마이즈너 테크닉 연기학원',
    template: '%s | KD4 액팅 스튜디오',
  },
  description:
    '서울 신촌·이대·서대문구 마이즈너 테크닉 연기학원. 현역 배우 직강·소수정예(6~8명). 연기 훈련·포트폴리오 제작·캐스팅 연계. KD4 액팅 스튜디오',
  keywords: [
    '연기학원', '마이즈너 테크닉', '마이즈너테크닉', '아메리칸 액팅 메소드', '아메리칸액팅메소드',
    '신촌 연기학원', '이대 연기학원', '서대문구 연기학원', '대현동 연기학원',
    '소수정예 연기학원', '현역 배우 직강', '연기 워크샵', '연기워크샵',
    '캐스팅', '오디션', '배우지망생', '배우 포트폴리오', '출연영상 제작',
    '캐스팅 연계', '연기 입문', '배우 훈련', '이바나 처벅 테크닉',
    '카메라 연기', '오디션 준비',
  ...
  openGraph: {
    title: 'KD4 액팅 스튜디오 | 서울 신촌·이대 마이즈너 테크닉 연기학원',
    description: '서울 신촌·이대·서대문구 마이즈너 테크닉 연기학원. 현역 배우 직강·소수정예(6~8명). 연기 훈련·포트폴리오 제작·캐스팅 연계.',
    url: 'https://kd4.club',
