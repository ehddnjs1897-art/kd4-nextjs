...
// 타겟 키워드: 남자독백(대본)·여자독백(대본)·연령대독백·오디션독백·독백대본 모음·독백 연습·영화/드라마/연극독백
const KEYWORDS = [
  '남자독백', '남자독백대본', '남자 독백 대본',
  '여자독백', '여자독백대본', '여자 독백 대본',
  '20대독백', '30대독백', '40대독백', '50대독백', '연령대별 독백',
  '오디션독백', '오디션 독백', '오디션 대본',
  '독백대본 모음', '독백 대본', '독백 대본 아카이브', '무료 독백 대본',
...
export async function generateMetadata({ searchParams }: { searchParams: SearchParams }): Promise<Metadata> {
  ...
  if (gender && !genre && !medium && !age) {
    ...
    title = `${g}독백 대본 ${count}편 무료 — 오디션·연습용 ${g} 독백 모음 | KD4 액팅 스튜디오`
    desc = `${g}독백 대본 ${count}편 무료. 영화·드라마·연극·뮤지컬 속 ${g} 배역 독백을 20대~50대 연령대·장르·감정선별로 찾아보세요. 오디션 독백 선정과 연기 독백 연습에 바로 활용할 수 있습니다.`
    ...
    desc = `${label} 독백 대본 ${count}편 무료. 남자독백·여자독백, 영화·드라마·연극·뮤지컬 장르별로 찾는 ${label} 독백 모음. 오디션 준비와 연기 독백 연습에 바로 쓸 수 있습니다.`
    ...
    desc = `${kw} 대본 ${count}편 무료. 남자독백·여자독백, 20대~50대 연령대, 장르·감정선별로 찾는 ${medium} 독백 대본 모음. 오디션 준비와 연기 연습에 바로 쓸 수 있습니다.`
    ...
    title = `독백 대본 아카이브 | 남자독백·여자독백 ${count}편 무료 — KD4 액팅 스튜디오`
    desc = `오디션·연습용 독백 ${count}편. 남자독백·여자독백, 20대~50대, 영화·드라마·연극·뮤지컬 장르별로 검색하세요. 배역·감정선·연령대로 찾는 한국 최대 독백 대본 아카이브.`
  }
      ...
      <PageJsonLd
        schemas={[
          ...
          buildWebPage({
            ...
            name: '독백 대본 아카이브 — 남자독백·여자독백 무료 모음',
            description: `오디션·연습용 독백 대본 ${totalCount}편 무료. 남자독백·여자독백, 20대~50대 연령대, 영화·드라마·연극·뮤지컬 장르별 독백 모음.`,
      ...
      <header style={{ marginBottom: 32 }}>
        ...
        <p style={{ fontFamily: 'var(--font-sans)', color: 'var(--text-warm)', fontSize: '0.95rem' }}>
          {hasFilter
            ...
            : `오디션·연습용 독백 대본 ${totalCount}편 무료 — 남자·여자, 연령대·작품·장르·감정선으로 찾아보세요.`}
        </p>
      </header>
