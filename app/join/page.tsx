...
const REVIEW_MARQUEE_ROW1 = [
  { text: '내 의지로 만들어진 연기가 아니라 의식 깊은 곳에서 건드려진 감정이 자연스럽게 뱉어지는 경험을 했습니다.', author: '강경' },
  { text: '카메라 앞에서든 무대 위에서든 진짜로 숨쉴 수 있는 방법의 물꼬를 터준 수업.', author: '김일' },
  { text: '안 보이던 업계의 길이 보였습니다. 현역 배우가 현실적으로 설명해주는 곳.', author: '한윤' },
]
const REVIEW_MARQUEE_ROW2 = [
  { text: '여러 연기 워크샵을 다녀봤지만 가장 의미있는 시간이었다.', author: '허' },
  { text: '다시 대사를 뱉어보니 색다른 감정들이 저를 휘몰아치게 하더라고요.', author: '조건' },
  { text: '5시간 동안 여섯 명을 한 명 한 명 집중해주셨어요. 학원에서 배울 수 없는 것들을 얻어간 귀중한 시간.', author: '김지' },
]
