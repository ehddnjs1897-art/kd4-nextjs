...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: '무료 상담 신청 | KD4 액팅 스튜디오',
    description: '소수정예 마이즈너 테크닉 연기 클래스. 무료 상담 신청. 서울 신촌.',
    images: [{ url: `${SITE_URL}/og-image.jpg`, width: 1200, height: 630, alt: 'KD4 액팅 스튜디오' }],
  },
}
...
const DISCOUNTS = [
  ...
  {
    tag: '앰배서더 할인',
    title: '지인 소개로 등록 시 두 분 모두 각 3만원 할인',
    desc: '지인 소개로 등록 시, 소개한 분과 등록한 분 모두 각 3만원씩 할인',
    isNew: true,
  },
  {
    tag: '재수강 할인',
    title: '2번째 수강부터 월 3만원 할인',
    desc: '같은 클래스를 재수강하는 경우, 두 번째 수강하는 달부터 매월 3만원 할인',
    isNew: true,
  },
  {
    tag: 'KD4 매니아 할인',
