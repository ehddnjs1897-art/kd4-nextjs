...
export const KD4_STATS: StatItem[] = [
  ...
  // 대표 확정 (2026-08-19): 수료 인원 150명 이상 — /join 히어로 '150명 현직 배우 수료'와 통일 (구 90+ 멤버 표기 폐기)
  { value: '150+', label: '현직 배우 수료' },
  // 사이트 전체 통일 표기: "최근 캐스팅 80건" (2026-08-30 대표 확정, 구 60건)
  { value: '80건', label: '최근 캐스팅' },
]
